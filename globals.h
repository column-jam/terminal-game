...
int x_pos = 60, y_pos = 1, room_number = 3, temp_x, temp_y, light_x_pos, light_y_pos, light_direction, direction_one, direction_two;
...
vector<string> room_two_but_technically_the_third_copy(height);
